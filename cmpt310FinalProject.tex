...
\begin{abstract}
   ...
   drastic consequences when implemented in the real world. This paper examines a 
   reinforcement learning algorithm that takes these delays into account. 
   To-do: insert results
