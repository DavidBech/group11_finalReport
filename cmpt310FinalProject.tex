...
A major strength of this algorithm comes from the fact that it is extremely useful for real-world applications in which there is almost always a stochastic process.
As referenced in the paper, this algorithmic approach to solving uncertainties pertaining to random delays can be implemented in a variety of scenarios.
For example, communication between a decision making computer and a remote robot will be affected by the medium in which they communicate. Wifi is commonly used for this purpose and corresponds to an average delay of roughly 20-40ms.
This proposed algorithm is also incredibly useful for autonomous car applications where any delay related inaccuracies can have extreme consequences.
Image, face, or object recognition and identification software in scientific or security applications could also benefit from this algorithm due to the varying additional processing required for each unique input.

To-do : edit this and add more + images
...
\subsection{IDK how we did it or something}

To-do, time to code some shit part 1

\subsection{IDK how we did it or something}

To-do, time to code some shit part 2
...
Wow, look at the stuff Todor did 

\subsection{Kaj Grant-Mathiasen}
Wow, look at the stuff Kaj did 

\subsection{Dakota Crozier}
Wow, look at the stuff Dakota did 

\subsection{David Bechert}
- Set up the Google colab file\\
- Set up the class that we wrote the agent in\\
- Set up initial LaTeX paper\\
- Wrote initial abstract and introduction sections of paper\\
- Made code for producing plots of data\\
